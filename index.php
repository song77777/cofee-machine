        ...
        <div class="col-6 coffee-list"> <!--Левая сторона (выбор кофе)-->
          <div class="row flex-column justify-content-around">
            ...
            <div class="coffee-item">
              <img src="img/americano.png" height=100 alt="Американо">
          ...
          <div class="row">-->
            <div class="coffee-item">
              <img src="img/cappuccino.png" height=100 alt="Капучино">
...
<!--          </div>
          ...
          <div class="row">-->
            <div class="coffee-item">
              <img src="img/espresso.png" height=100 alt="Эспрессо">
...
<!--          </div>
          ...
          <div class="row">-->
            <div class="coffee-item">
              <img src="img/latte.jpg" height=100 alt="Латте">
